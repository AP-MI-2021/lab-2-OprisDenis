...
def is_prime(n):#verifica daca un numar dat este prim
    if n == 2:
        return True
    if n < 2 or n % 2 == 0:
        return False
...
def get_largest_prime_below(n):#cauta cel mai mare numar mai mic decat un numar dat si verifica daca acest numar este prim
    if n <= 2:
        return "(Error) n <= 2"
